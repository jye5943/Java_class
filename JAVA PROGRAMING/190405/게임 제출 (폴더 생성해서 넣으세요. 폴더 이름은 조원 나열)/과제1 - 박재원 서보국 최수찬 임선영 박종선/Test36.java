/***************
 * date : 2019.04.06
 * project name : simple turn game
 * version : 1.0
 * group : 박재원, 서보국, 최수찬, 임선영, 박종선
 * content:
 * 강의시간에 작성했던 기존의 코드에서 
 * 1. player 공격시 한명의 enemy를 선택하여 공격할 수 있다.
 * 2. enemy 공격시 살아있는 enemy가 모두 공격하게끔 수정 
 * 3. property(속성 : 불, 물, 풀)을 추가하여 
 *    상성을 적용시켜 데미지가 증감되어 적용된다. 
 * 
 */
